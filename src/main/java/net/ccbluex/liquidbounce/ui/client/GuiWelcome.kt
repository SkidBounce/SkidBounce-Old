...
class GuiWelcome : GuiScreen() {
    ...
    override fun drawScreen(mouseX: Int, mouseY: Int, partialTicks: Float) {
        ...
        Fonts.font35.run {
            ...
            drawCenteredString("Right-click modules with a '+' next to them to edit their settings.", width / 2F, 80f + fontHeight * 5, 0xffffff, true)
            drawCenteredString("Hover a module to see it's description.", width / 2F, 80f + fontHeight * 6, 0xffffff, true)

            drawCenteredString("§lImportant Commands:", width / 2F, 80f + fontHeight * 8, 0xffffff, true)
            drawCenteredString(".bind <module> <key> / .bind <module> none", width / 2F, 80f + fontHeight * 9, 0xffffff, true)
            drawCenteredString(".autosettings load <name> / .autosettings list", width / 2F, 80f + fontHeight * 10, 0xffffff, true)
