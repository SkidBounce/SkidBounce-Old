...
class BlockCounter(x: Double = 520.0, y: Double = 245.0) : Element(x = x, y = y) {
    ...
    private val onScaffold by BooleanValue("ScaffoldOnly", true)

    private val textColorMode by ListValue("Text-Color", arrayOf("Custom", "Rainbow", "Gradient"), "Custom")
    private val textRed by IntValue("Text-R", 255, 0..255) { textColorMode == "Custom" }
    private val textGreen by IntValue("Text-G", 255, 0..255) { textColorMode == "Custom" }
    ...
    private val borderRed by IntValue("Border-R", 0, 0..255)
    private val borderGreen by IntValue("Border-G", 0, 0..255)
    private val borderBlue by IntValue("Border-B", 0, 0..255)
    private val borderAlpha by IntValue("Border-Alpha", 255, 0..255)
